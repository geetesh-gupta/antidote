...
handle_info(management_tick, State0) ->
    ...
    MaxStart = app_helper:get_env(antidote, vnode_rolling_start,
...
schedule_management_timer() ->
    ManagementTick = app_helper:get_env(antidote,
...
limit_ownership_handoff(Transfers, IsResizing) ->
    Limit = app_helper:get_env(antidote,
...
get_vnode(IdxList, Mod, State) ->
    ...
    MaxStart = app_helper:get_env(antidote, vnode_parallel_start,
                                  ?DEFAULT_VNODE_ROLLING_START),
